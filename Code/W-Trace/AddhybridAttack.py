...
if __name__ == "__main__":
    ...
    for trip_id in trip_idSeries:
        df_2=pd.read_csv('../'+config['global']['global_fol']+config['global']['technique']+'/256_len/'+config['global']['slicenumber']+'/payload_strength/different_watermarks/payload_5/watermarked_data/'+trip_id+'/noise_added/cropfromlast.csv')
        data_three = df_2[['c_w','c_w_long','cum_sum','watermarked_long', 'watermarked_lat','latitude','longitude']]
        ...
        compare_dist=data_three[['watermarked_lat','watermarked_long','latitude','longitude']]
        ...
        final_df.to_csv( '../'+config['global']['global_fol']+config['global']['technique']+'/256_len/'+config['global']['slicenumber']+'/payload_strength/different_watermarks/payload_5/watermarked_data/'+trip_id+'/noise_added/hybrid.csv',index=False)
