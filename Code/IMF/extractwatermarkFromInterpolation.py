...
if __name__ == "__main__":
    ...
    df1 = pd.read_csv('/data/dadwal/watermarkingTraj/data/All_results/IMF/256_len/watermark_corrWithDistance_finalused.csv',header=None)
    df1.columns=['trip_id','mean_dist','min_dist','max_dist','watermark_corr']
    trip_idSeries = df1['trip_id'].values

    i=0

    watermark=np.load("/data/dadwal/watermarkingTraj/data/All_results/FFT_complexNum//256_len/watermark_random_sumZero_256.npy",allow_pickle=True)
